...
const serviceDetails = {
  'tehnica-mckenzie': {
    ...
    description: 'Tehnica McKenzie este o metodă de diagnostic și tratament dezvoltată de fizioterapeutul Robin McKenzie. Această tehnică se concentrează în special pe tratamentul durerilor de spate și gât.',
    benefits: [
  ...
  'tehnica-mulligan': {
    ...
    description: 'Conceptul Mulligan reprezintă o abordare inovatoare în terapia manuală, dezvoltată de Brian Mulligan. Se bazează pe aplicarea unor mobilizări susținute combinate cu mișcări active ale pacientului.',
    benefits: [
